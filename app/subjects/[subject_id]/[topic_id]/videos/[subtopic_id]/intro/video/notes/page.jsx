  ...
  return (
    <div>
      {note.size < 2 ? (
        ...
        <div className="max-container max-w-xl mx-auto p-4 text-center justify-center items-center flex">
          <h2 className="font-bold  text-gray-700 p-8 text-center"></h2>
          Not Available for now. To be uploaded soon
        </div>
      )}
    </div>
  );
