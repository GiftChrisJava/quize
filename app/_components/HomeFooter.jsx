...
function HomeFooter() {
  ...
  return (
    <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 mt-14 md:mt-4">
    <hr className='mb-10'/>
  <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
    <div className="sm:col-span-2">
      <a href="/" aria-label="Go home" title="Company" className="inline-flex items-center">
        ...
        <span className="ml-2 text-xl font-bold tracking-wide text-gray-800 uppercase">MEep</span>
      </a>
    ...
    <div className="space-y-2 text-sm">
      ...
      <div className="flex">
        ...
        <a href="tel:+265887036123" aria-label="Our phone" title="Our phone" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">+265887036123</a>
      </div>
      <div className="flex">
        <p className="mr-1 text-gray-800">Email:</p>
        <a href="mailto:bed-com-09-19@unima.ac.mw" aria-label="Our email" title="Our email" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">bed-com-09-19@unima.ac.mw</a>
      </div>
    ...
    <div>
      ...
      <p className="mt-4 text-sm text-gray-500">
       Connect and talk to us for comments or any issues encountered with Meep.
      </p>
    </div>
  </div>
